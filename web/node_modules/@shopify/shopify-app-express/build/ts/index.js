...
function overrideLoggerPackage(logger) {
    ...
    var warningFunction = function (message, context) {
        ...
        return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
            return [2 /*return*/, logger.warning(message, tslib_1.__assign(tslib_1.__assign({}, baseContext), context))];
        }); });
    };
    return tslib_1.__assign(tslib_1.__assign({}, logger), { log: function (severity, message, context) {
            if (context === void 0) { context = {}; }
            return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, logger.log(severity, message, tslib_1.__assign(tslib_1.__assign({}, baseContext), context))];
            }); });
        }, debug: function (message, context) {
            if (context === void 0) { context = {}; }
            return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, logger.debug(message, tslib_1.__assign(tslib_1.__assign({}, baseContext), context))];
            }); });
        }, info: function (message, context) {
            if (context === void 0) { context = {}; }
            return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, logger.info(message, tslib_1.__assign(tslib_1.__assign({}, baseContext), context))];
            }); });
        }, warning: warningFunction, error: function (message, context) {
            if (context === void 0) { context = {}; }
            return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, logger.error(message, tslib_1.__assign(tslib_1.__assign({}, baseContext), context))];
            }); });
    ...
    return function (version, message) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                ...
                return [2 /*return*/, warningFunction("[Deprecated | ".concat(version, "] ").concat(message))];
            });
        });
    };
}
