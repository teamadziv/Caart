...
function overrideLoggerPackage(logger) {
  ...
  const warningFunction = async (message, context = {}) => logger.warning(message, {
    ...baseContext,
    ...context
  });
  return {
    ...logger,
    log: async (severity, message, context = {}) => logger.log(severity, message, {
      ...baseContext,
      ...context
    }),
    debug: async (message, context = {}) => logger.debug(message, {
      ...baseContext,
      ...context
    }),
    info: async (message, context = {}) => logger.info(message, {
      ...baseContext,
      ...context
    }),
    warning: warningFunction,
    error: async (message, context = {}) => logger.error(message, {
      ...baseContext,
      ...context
    }),
...
function deprecated(warningFunction) {
  return async function (version$1, message) {
