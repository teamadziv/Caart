...
:root { --polaris-version-number: '9.24.0'; }
...
.Polaris-ActionList__Title { font-size: var(--p-font-size-2); font-weight: var(--p-font-weight-semibold); line-height: var(--p-line-height-1); text-transform: uppercase; padding: var(--p-space-3) var(--p-space-4) var(--p-space-3) var(--p-space-4); }
...
@media (max-width: 40em) { .Polaris-Choice__Control { --pc-choice-size: 1.375rem; } }
...
@media (max-width: 40em) { .Polaris-Choice__Descriptions { --pc-choice-size: 1.375rem; } }
...
@media (max-width: 40em) { .Polaris-RadioButton__Backdrop { --pc-icon-size-small: 0.625rem; } }
...
@media (max-width: 40em) { .Polaris-ChoiceList__ChoiceItem:not(:last-child) { margin-bottom: var(--p-space-4); } }
...
@media (max-width: 40em) { .Polaris-ChoiceList__ChoiceChildren { margin-top: var(--p-space-4); } }

.Polaris-ChoiceList__ChoiceError { margin-top: var(--p-space-1); margin-bottom: var(--p-space-2); }

@media (max-width: 40em) { .Polaris-ChoiceList__ChoiceError { margin-top: var(--p-space-4); } }
...
@media (max-width: 40em) { .Polaris-ChoiceList__Title { margin-bottom: var(--p-space-5); } }
...
@media (min-width: 48.0625em) { .Polaris-Modal-Dialog__Modal.Polaris-Modal-Dialog--sizeSmall { max-width: calc(100% - var(--p-space-16)); } }

@media (min-width: 27.75em) { .Polaris-Modal-Dialog__Modal.Polaris-Modal-Dialog--sizeSmall { max-width: 23.75rem; } }

@media (min-width: 48.0625em) { .Polaris-Modal-Dialog__Modal.Polaris-Modal-Dialog--sizeLarge { max-width: calc(100% - var(--p-space-16)); } }
...
@media (min-width: 48.0625em) { .Polaris-Modal-Dialog__Modal.Polaris-Modal-Dialog--fullScreen { height: unset; } }
...
.Polaris-IndexTable__TableHeading { padding: var(--p-space-2) var(--p-space-4); text-align: left; font-weight: var(--p-font-weight-medium); color: var(--p-text-subdued); font-size: var(--p-font-size-1); white-space: nowrap; border: 0; }
...
.Polaris-IndexTable__TableHeadingSortButton { background: none; padding: 0; border: 0; cursor: pointer; display: flex; align-items: center; justify-content: center; font-weight: var(--p-font-weight-medium); color: var(--p-text-subdued); font-size: var(--p-font-size-1); }
...
@media (min-width: 28.625em) { .Polaris-IndexTable__TableCell--first + .Polaris-IndexTable__TableCell { position: sticky; z-index: var(--pc-index-table-sticky-cell); } }
...
@media (min-width: 28.625em) { .Polaris-IndexTable--tableStickyScrolling .Polaris-IndexTable__TableCell:last-child, .Polaris-IndexTable--tableStickyScrolling .Polaris-IndexTable__TableHeading--last { filter: drop-shadow(-0.0625rem 0 0 var(--p-divider)); } }
...
@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-MediaCard__MediaContainer { border-top-left-radius: var(--p-border-radius-2); border-top-right-radius: var(--p-border-radius-2); } }
...
@media (max-width: 48.0525em) { .Polaris-Navigation__LogoContainer { display: flex; flex: 0 0 3.5rem; align-items: center; height: 3.5rem; padding: 0 var(--p-space-2) 0 var(--p-space-4); background-color: var(--p-surface); box-shadow: var(--p-shadow-top-bar); margin-bottom: var(--p-space-4); flex-basis: 3.5rem; flex-basis: calc(3.5rem + constant(safe-area-inset-left)); flex-basis: calc(3.5rem + env(safe-area-inset-left)); padding-left: var(--p-space-4); padding-left: calc(var(--p-space-4) + constant(safe-area-inset-left)); padding-left: calc(var(--p-space-4) + env(safe-area-inset-left)); } }
...
@media (max-width: 48.0625em) and (min-width: 46.5em), (min-width: 61.5em) { [data-has-navigation] .Polaris-Page__Content { padding-top: var(--p-space-5); } }

@media (min-width: 46.5em) { .Polaris-Page__Content { padding-top: var(--p-space-5); } }
...
@media (max-width: 45em), (min-width: 48.0625em) and (max-width: 61.5em) { [data-has-navigation] .Polaris-ResourceItem__Disclosure { display: flex; flex: 0 0 var(--pc-resource-item-disclosure-width); justify-content: center; align-items: center; } }

@media (max-width: 46.5em) { .Polaris-ResourceItem__Disclosure { display: flex; flex: 0 0 var(--pc-resource-item-disclosure-width); justify-content: center; align-items: center; } }
...
.Polaris-SkeletonDisplayText__DisplayText { --pc-skeleton-display-text-height: var(--p-line-height-2); --pc-skeleton-display-text-height-not-condensed: var(--p-line-height-2); max-width: 7.5rem; display: flex; background-color: var(--p-surface-neutral); border-radius: var(--p-border-radius-base); }
...
@media (max-width: 48.0625em) and (min-width: 46.5em), (min-width: 61.5em) { [data-has-navigation] .Polaris-SkeletonPage__Content { padding-top: var(--p-space-5); } }

@media (min-width: 46.5em) { .Polaris-SkeletonPage__Content { padding-top: var(--p-space-5); } }
