...
export default function TrustBadgeSetting({ setdrawerCartSettings, handleFullCartSelectChange, trustBadgeSettings, handleIconShowHide, addActiveInMenu, id, removeActiveInMenu }) {
