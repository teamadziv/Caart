 ...
 */
export async function bundleExtension(options, processEnv = process.env) {
...
export async function bundleThemeExtension(extension, options) {
...
function getESBuildOptions(options, processEnv = process.env) {
