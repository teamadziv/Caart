...
export declare function setupPreviewThemeAppExtensionsProcess({ allExtensions, apiKey, storeFqdn, theme, themeExtensionPort, notify, usesUnifiedDeployment, token, }: Pick<PreviewThemeAppExtensionsOptions, 'token' | 'usesUnifiedDeployment'> & {
