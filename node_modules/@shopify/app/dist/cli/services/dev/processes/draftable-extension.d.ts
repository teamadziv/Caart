...
export declare function setupDraftableExtensionsProcess({ unifiedDeployment, localApp, apiKey, token, remoteApp, ...options }: Omit<DraftableExtensionOptions, 'remoteExtensionIds' | 'extensions'> & {
