...
export const pushUpdatesForDraftableExtensions = async ({ stderr, stdout, abortSignal: signal }, { extensions, token, apiKey, unifiedDeployment, remoteExtensionIds: remoteExtensions, proxyUrl, localApp: app }) => {
...
export async function setupDraftableExtensionsProcess({ unifiedDeployment, localApp, apiKey, token, remoteApp, ...options }) {
