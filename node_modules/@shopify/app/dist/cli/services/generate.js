...
async function generate(options) {
    ...
    const { validSpecifications, overlimit } = groupBy(specifications, (spec) => app.extensionsForType(spec).length < spec.registrationLimit ? 'validSpecifications' : 'overlimit');
