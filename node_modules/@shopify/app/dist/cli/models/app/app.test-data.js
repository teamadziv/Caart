import { App, WebType } from './app.js';
...
export function testApp(app = {}, schemaType = 'legacy') {
    ...
    const newApp = new App(app.name ?? 'App', app.idEnvironmentVariableName ?? 'SHOPIFY_API_KEY', app.directory ?? '/tmp/project', app.packageManager ?? 'yarn', app.configuration ?? getConfig(), app.nodeDependencies ?? {}, app.webs ?? [
        {
            directory: '',
            configuration: {
    ...
    ], app.allExtensions ?? [], app.usesWorkspaces ?? false, app.dotenv, app.errors);
